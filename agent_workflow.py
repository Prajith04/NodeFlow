...
def action_agent(state: State) -> Dict[str, Any]:
    ...
    - /alert/log: For JSON validation errors or anomalies.
      Payload schema: {alert_type: str, details: str}
    - /compliance/flag: For PDFs with regulatory issues or high-value invoices.
      Payload schema: {document_type: str, reason: str}
...
config = {"configurable": {"thread_id": "user301"}}
def run_workflow(input_data: str):
    """
    Run the agent workflow with the provided input data.
    """
